<template>
  <div class="manageAdd">
    ...
    <el-dialog class="textPri" title="添加家教排行" :visible.sync="dialogFormVisible">
      <el-form :model="bannerAdd">
        ...
        <el-form-item label="报名人数" class="item">
          <el-input v-model="bannerAdd.num" autocomplete="off" clearable></el-input>
        </el-form-item>
        <el-form-item label="授课机构" class="item">
          <el-input v-model="bannerAdd.teacherImg" autocomplete="off" clearable></el-input>
        </el-form-item>
      </el-form>
