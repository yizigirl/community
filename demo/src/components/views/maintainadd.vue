<template>
  <div class="manageAdd">
    ...
    <el-dialog class="textPri" title="添加维修" :visible.sync="dialogFormVisible">
      ...
      <el-form :model="waterStation" label-width="70px">
        <el-form-item label="类型">
          <el-input v-model="waterStation.type" placeholder="月销售量" type="number"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="waterStation" label-width="70px">
      ...
      <el-form :model="waterStation" label-width="70px">
        <el-form-item label="商家信息">
          <el-input v-model="waterStation.info" placeholder="商家信息"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="waterStation" label-width="70px">
